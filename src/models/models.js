...
models.defineEnumProperty('TEXT_SEARCH_ADA_DOC_001', 'text-search-ada-doc-001', { types: [apiTypes.EMBEDDINGS] });
// /v1/moderations:
...
const isValidModel = (model) => models.values().includes(model);
